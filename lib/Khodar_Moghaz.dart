...
class Moghaz extends StatefulWidget {
  @override
  _MoghazState createState() => _MoghazState();
}

class _MoghazState extends State<Moghaz> {
  @override
    ...
    return Scaffold(
      body: StreamBuilder(
        stream: Firestore.instance
            .collection('products')
            .where('category', isEqualTo: 'خضروات وفاكهة مجهزه')
            .snapshots(),
